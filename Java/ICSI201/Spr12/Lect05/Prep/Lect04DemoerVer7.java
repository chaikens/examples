class Lect04DemoerVer7
{
  public static void main(String asdf[])
  {
    ...
    mt.forward(scale*defFwdDist);
    mt.turnLeft();     //class voted to make an L by turning left
    mt.forward(scale*defFwdDist);      //we now have two lines of the L
    mt.turnLeft();
    mt.forward(scale*defFwdDist*0.3);    //the toe was too long, so we tried a shorter length
