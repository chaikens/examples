...
public class Turtle extends SimpleTurtle
{
  ...
  public void drawL(double scale)
  {
    ...
    int savedPenWidth;                   //Added after Save03 to make the method:
    savedPenWidth = this.getPenWidth();  //(1) leave the PenWidth unchanged after the call from
                                         //    before the call, 
    this.setPenWidth(1);                //(2) specify the exact PenWidths for the L itself.
    ...
    this.setPenWidth(savedPenWidth); //Replace the value written in the Turtle as PenWidth
                                     //by what is was at the time the method was called.
  }
